  ...
  "node_modules/.pnpm/lodash@4.17.21/node_modules/lodash/lodash.js"(exports, module) {
    ...
    (function() {
      ...
      var nodeUtil = (function() {
        try {
          var types14 = freeModule && freeModule.require && freeModule.require("util").types;
          if (types14) {
            return types14;
          }
      ...
      var runInContext = (function runInContext2(context) {
        ...
        function shuffleSelf(array, size6) {
        ...
        function chunk(array, size6, guard) {
          if (guard ? isIterateeCall(array, size6, guard) : size6 === undefined2) {
            size6 = 1;
          } else {
          ...
          while (index2 < length) {
            result2[resIndex++] = baseSlice(array, index2, index2 += size6);
          }
          return result2;
        }
        ...
        var without3 = baseRest(function(array, values2) {
...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/.pnpm/use-sync-external-store@1.5.0_react@19.1.1/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      function useSyncExternalStore$2(subscribe, getSnapshot3) {
      ...
      function useSyncExternalStore$1(subscribe, getSnapshot3) {
        return getSnapshot3();
      }
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React45 = __require("react"), objectIs = "function" === typeof Object.is ? Object.is : is, useState26 = React45.useState, useEffect33 = React45.useEffect, useLayoutEffect6 = React45.useLayoutEffect, useDebugValue = React45.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var Primitive = NODES.reduce((primitive, node) => {
  ...
  const Node3 = React3.forwardRef((props, forwardedRef) => {
...
function createCollection(name) {
  ...
  const CollectionProvider = (props) => {
    ...
    return /* @__PURE__ */ jsx8(CollectionProviderImpl, { scope: scope2, itemMap, collectionRef: ref, children });
  };
  ...
  const CollectionSlot = React6.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ jsx8(CollectionSlotImpl, { ref: composedRefs, children });
    }
  );
  ...
  const CollectionItemSlot = React6.forwardRef(
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ jsx8(CollectionItemSlotImpl, { ...{ [ITEM_DATA_ATTR]: "" }, ref: composedRefs, children });
    }
  );
...
var CollapsibleContent = React11.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx9(Presence, { present: forceMount || context.open, children: ({ present }) => /* @__PURE__ */ jsx9(CollapsibleContentImpl, { ...contentProps, ref: forwardedRef, present }) });
  }
);
...
var Accordion = React13.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx11(Collection.Provider, { scope: props.__scopeAccordion, children: type === "multiple" ? /* @__PURE__ */ jsx11(AccordionImplMultiple, { ...multipleProps, ref: forwardedRef }) : /* @__PURE__ */ jsx11(AccordionImplSingle, { ...singleProps, ref: forwardedRef }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx11(
      AccordionValueProvider,
      {
        ...
        children: /* @__PURE__ */ jsx11(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible, children: /* @__PURE__ */ jsx11(AccordionImpl, { ...accordionSingleProps, ref: forwardedRef }) })
      }
    );
  }
);
var AccordionImplMultiple = React13.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx11(
    AccordionValueProvider,
    {
      ...
      children: /* @__PURE__ */ jsx11(AccordionCollapsibleProvider, { scope: props.__scopeAccordion, collapsible: true, children: /* @__PURE__ */ jsx11(AccordionImpl, { ...accordionMultipleProps, ref: forwardedRef }) })
    }
  );
});
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx11(
      AccordionImplProvider,
      {
        ...
        direction: dir,
        orientation,
        children: /* @__PURE__ */ jsx11(Collection.Slot, { scope: __scopeAccordion, children: /* @__PURE__ */ jsx11(
          Primitive.div,
          {
            ...accordionProps,
...
var AccordionTrigger = React13.forwardRef(
  (props, forwardedRef) => {
    ...
    const collapsibleScope = useCollapsibleScope(__scopeAccordion);
    return /* @__PURE__ */ jsx11(Collection.ItemSlot, { scope: __scopeAccordion, children: /* @__PURE__ */ jsx11(
      Trigger,
      {
...
function Accordion2({
  ...
  return /* @__PURE__ */ jsx12(Root22, { "data-slot": "accordion", ...props });
}
...
function AccordionTrigger2({
  ...
  return /* @__PURE__ */ jsx12(Header, { className: "flex", children: /* @__PURE__ */ jsxs(
    Trigger2,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx12(ChevronDown, { className: "text-muted-foreground pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200" })
      ]
    }
  ) });
}
...
var ArrayFieldComponent = observer(
  ({
    ...
    const [openRow, setOpenRow] = React14.useState(void 0);
    return /* @__PURE__ */ jsxs2("div", { children: [
      /* @__PURE__ */ jsxs2("div", { className: "flex justify-between items-center", children: [
        /* @__PURE__ */ jsx13(Label2, { children: (0, import_lodash.startCase)(field.name) }),
        /* @__PURE__ */ jsx13(
          Button,
          {
            size: "sm",
      ...
      /* @__PURE__ */ jsx13(Accordion2, { type: "single", collapsible: true, value: openRow, onValueChange: setOpenRow, children: rows.map((row, index2) => {
        const rowKey = index2.toString();
        return /* @__PURE__ */ jsxs2(AccordionItem2, { value: rowKey, children: [
          /* @__PURE__ */ jsxs2(AccordionTrigger2, { className: "text-sm", children: [
            "Item ",
            index2 + 1
          ] }),
          /* @__PURE__ */ jsx13(AccordionContent2, { children: /* @__PURE__ */ jsxs2("div", { className: "flex flex-col gap-2", children: [
            field.fields.map((nestedField) => /* @__PURE__ */ jsx13(
              FieldComponent,
              {
                field: nestedField,
                node,
...
function useSize(element) {
  const [size5, setSize] = React16.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React17.useState(null);
  const [bubbleInput, setBubbleInput] = React17.useState(null);
...
var CheckboxTrigger = React17.forwardRef(
  ({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
    ...
    const initialCheckedStateRef = React17.useRef(checked);
    React17.useEffect(() => {
...
var CheckboxIndicator = React17.forwardRef(
  (props, forwardedRef) => {
...
var CheckboxBubbleInput = React17.forwardRef(
  ({ __scopeCheckbox, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React17.useRef(isIndeterminate(checked) ? false : checked);
    return /* @__PURE__ */ jsx14(
      Primitive.input,
      {
        type: "checkbox",
...
var CheckboxFieldComponent = observer2(
  ({
    ...
    const id = useId2();
    return /* @__PURE__ */ jsxs4("div", { className: "flex items-center space-x-2", children: [
      /* @__PURE__ */ jsx16(
        Checkbox2,
        {
          id,
      ...
      /* @__PURE__ */ jsx16(Label2, { htmlFor: id, children: (0, import_lodash2.startCase)(field.name) })
    ] });
  }
);
...
var NumberFieldComponent = observer3(
  ({
    ...
    return /* @__PURE__ */ jsxs5("div", { className: "grid w-full max-w-sm items-center gap-1.5", children: [
      /* @__PURE__ */ jsx17(Label2, { htmlFor: id, children: (0, import_lodash3.startCase)(field.name) }),
      /* @__PURE__ */ jsx17(
        Input,
        {
          id,
...
var PopperAnchor = React28.forwardRef(
  (props, forwardedRef) => {
...
var PopperContent = React28.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopper,
      side = "bottom",
...
var PopperArrow = React28.forwardRef(function PopperArrow2(props, forwardedRef) {
...
var Portal = React29.forwardRef((props, forwardedRef) => {
  ...
  return container ? ReactDOM3.createPortal(/* @__PURE__ */ jsx23(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
// node_modules/.pnpm/@radix-ui+react-select@2.2.6_@types+react-dom@19.1.7_@types+react@19.1.10__@types+react_fac4ee32bc8ebade400a9feb40353df4/node_modules/@radix-ui/react-select/dist/index.mjs
import { Fragment as Fragment6, jsx as jsx25, jsxs as jsxs6 } from "react/jsx-runtime";
...
var Select = (props) => {
  ...
  return /* @__PURE__ */ jsx25(Root23, { ...popperScope, children: /* @__PURE__ */ jsxs6(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx25(
      Primitive.span,
      {
        ...
        children: shouldShowPlaceholder(context.value) ? /* @__PURE__ */ jsx25(Fragment6, { children: placeholder }) : children
      }
    );
  }
);
...
var SelectIcon = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx25(Primitive.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "\u25BC" });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx25(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: /* @__PURE__ */ jsx25(Combination_default, { as: Slot2, allowPinchZoom: true, children: /* @__PURE__ */ jsx25(
          FocusScope,
          {
            asChild: true,
...
var SelectGroup = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return /* @__PURE__ */ jsx25(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: /* @__PURE__ */ jsx25(Primitive.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx25(Primitive.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxs6(Fragment6, { children: [
      /* @__PURE__ */ jsx25(Primitive.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? /* @__PURE__ */ jsx25(Primitive.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectSeparator = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx25(Primitive.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
...
function Select2({
  ...
  return /* @__PURE__ */ jsx26(Root24, { "data-slot": "select", ...props });
}
function SelectValue2({
  ...props
}) {
  return /* @__PURE__ */ jsx26(Value, { "data-slot": "select-value", ...props });
}
function SelectTrigger2({
  ...
  return /* @__PURE__ */ jsxs7(
    Trigger3,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx26(Icon2, { asChild: true, children: /* @__PURE__ */ jsx26(ChevronDown, { className: "size-4 opacity-50" }) })
      ]
    }
  );
}
function SelectContent2({
  ...
  return /* @__PURE__ */ jsx26(Portal2, { children: /* @__PURE__ */ jsxs7(
    Content22,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx26(SelectScrollUpButton2, {}),
        /* @__PURE__ */ jsx26(
          Viewport,
          {
            className: cn(
        ...
        /* @__PURE__ */ jsx26(SelectScrollDownButton2, {})
      ]
    }
  ) });
}
function SelectItem2({
  ...
  return /* @__PURE__ */ jsxs7(
    Item2,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx26("span", { className: "absolute right-2 flex size-3.5 items-center justify-center", children: /* @__PURE__ */ jsx26(ItemIndicator, { children: /* @__PURE__ */ jsx26(Check, { className: "size-4" }) }) }),
        /* @__PURE__ */ jsx26(ItemText, { children })
      ]
    }
  );
}
function SelectScrollUpButton2({
  ...
  return /* @__PURE__ */ jsx26(
    ScrollUpButton,
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsx26(ChevronUp, { className: "size-4" })
    }
  );
}
function SelectScrollDownButton2({
  ...
  return /* @__PURE__ */ jsx26(
    ScrollDownButton,
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsx26(ChevronDown, { className: "size-4" })
    }
  );
}
...
var SelectFieldComponent = observer4(
  ({
    ...
    return /* @__PURE__ */ jsxs8("div", { className: "grid w-full max-w-sm items-center gap-1.5", children: [
      /* @__PURE__ */ jsx27(Label2, { htmlFor: id, children: (0, import_lodash4.startCase)(field.name) }),
      /* @__PURE__ */ jsxs8(
        Select2,
        {
          value,
          ...
          children: [
            /* @__PURE__ */ jsx27(SelectTrigger2, { id, children: label }),
            /* @__PURE__ */ jsx27(SelectContent2, { children: field.options.map((option) => /* @__PURE__ */ jsx27(SelectItem2, { value: option.value, children: option.label }, option.value)) })
          ]
        }
      )
    ] });
...
var TextFieldComponent = observer5(
  ({
    ...
    return /* @__PURE__ */ jsxs9("div", { className: "grid w-full max-w-sm items-center gap-1.5", children: [
      /* @__PURE__ */ jsx28(Label2, { htmlFor: id, children: (0, import_lodash5.startCase)(field.name) }),
      /* @__PURE__ */ jsx28(
        Input,
        {
          id,
...
import { Fragment as Fragment7, jsx as jsx29, jsxs as jsxs10 } from "react/jsx-runtime";
...
var DialogTrigger = React39.forwardRef(
  (props, forwardedRef) => {
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx29(PortalProvider, { scope: __scopeDialog, forceMount, children: React39.Children.map(children, (child) => /* @__PURE__ */ jsx29(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx29(Portal, { asChild: true, container, children: child }) })) });
};
DialogPortal.displayName = PORTAL_NAME3;
var OVERLAY_NAME = "DialogOverlay";
var DialogOverlay = React39.forwardRef(
  (props, forwardedRef) => {
...
var DialogOverlayImpl = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      /* @__PURE__ */ jsx29(Combination_default, { as: Slot3, allowPinchZoom: true, shards: [context.contentRef], children: /* @__PURE__ */ jsx29(
        Primitive.div,
        {
          "data-state": getState4(context.open),
          ...overlayProps,
...
var DialogContentModal = React39.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME5, props.__scopeDialog);
    const contentRef = React39.useRef(null);
...
var DialogContentNonModal = React39.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME5, props.__scopeDialog);
...
var DialogContentImpl = React39.forwardRef(
  (props, forwardedRef) => {
...
var DialogTitle = React39.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDialog, ...titleProps } = props;
    const context = useDialogContext(TITLE_NAME, __scopeDialog);
    return /* @__PURE__ */ jsx29(Primitive.h2, { id: context.titleId, ...titleProps, ref: forwardedRef });
  }
);
DialogTitle.displayName = TITLE_NAME;
var DESCRIPTION_NAME = "DialogDescription";
var DialogDescription = React39.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDialog, ...descriptionProps } = props;
    const context = useDialogContext(DESCRIPTION_NAME, __scopeDialog);
    return /* @__PURE__ */ jsx29(Primitive.p, { id: context.descriptionId, ...descriptionProps, ref: forwardedRef });
  }
);
DialogDescription.displayName = DESCRIPTION_NAME;
var CLOSE_NAME = "DialogClose";
var DialogClose = React39.forwardRef(
  (props, forwardedRef) => {
...
function Dialog2({
  ...
  return /* @__PURE__ */ jsx30(Root4, { "data-slot": "dialog", ...props });
}
function DialogTrigger2({
  ...props
}) {
  return /* @__PURE__ */ jsx30(Trigger4, { "data-slot": "dialog-trigger", ...props });
}
function DialogPortal2({
  ...props
}) {
  return /* @__PURE__ */ jsx30(Portal3, { "data-slot": "dialog-portal", ...props });
}
...
function DialogContent2({
  ...
  return /* @__PURE__ */ jsxs11(DialogPortal2, { "data-slot": "dialog-portal", children: [
...
// src/store/MediaField.tsx
import { useState as useState16, useId as useId6 } from "react";
...
var MediaFieldComponent = observer6(
  ({
    ...
    return /* @__PURE__ */ jsxs12("div", { className: "grid w-full max-w-sm items-center gap-1.5", children: [
      /* @__PURE__ */ jsx31(Label2, { htmlFor: id, children: (0, import_lodash6.startCase)(field.name) }),
      /* @__PURE__ */ jsxs12(Dialog2, { open: dialogOpen, onOpenChange: setDialogOpen, children: [
        /* @__PURE__ */ jsx31(DialogTrigger2, { asChild: true, children: /* @__PURE__ */ jsx31(Button, { variant: "outline", className: "w-full", children: value ? "Change Media" : "Select Media" }) }),
        /* @__PURE__ */ jsxs12(DialogContent2, { className: "max-w-4xl h-[80vh]", children: [
          /* @__PURE__ */ jsx31(DialogHeader, { children: /* @__PURE__ */ jsx31(DialogTitle2, { children: "Enter Media URL" }) }),
          /* @__PURE__ */ jsxs12("div", { className: "flex gap-2 p-4", children: [
            /* @__PURE__ */ jsx31(
              Input,
              {
                type: "url",
            ...
            /* @__PURE__ */ jsx31(Button, { onClick: handleUrlSubmit, children: "Set Media" })
          ] }),
          inputValue && /* @__PURE__ */ jsx31("div", { className: "p-4", children: /* @__PURE__ */ jsx31(
            "img",
            {
              src: inputValue,
              alt: "Preview",
      ...
      value && /* @__PURE__ */ jsx31("div", { className: "mt-2", children: /* @__PURE__ */ jsx31(
        "img",
        {
          src: value,
          alt: "Selected media",
...
var TextareaFieldComponent = observer7(
  ({
    ...
    const value = field.getValue(node, fullPath);
    const id = useId7();
    const [dialogOpen, setDialogOpen] = useState17(false);
    const [dialogValue, setDialogValue] = useState17(value);
    ...
    return /* @__PURE__ */ jsxs13("div", { className: "grid w-full max-w-sm items-center gap-1.5", children: [
      /* @__PURE__ */ jsxs13("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsx33(Label2, { htmlFor: id, children: (0, import_lodash7.startCase)(field.name) }),
        /* @__PURE__ */ jsxs13(Dialog2, { open: dialogOpen, onOpenChange: setDialogOpen, children: [
          /* @__PURE__ */ jsx33(DialogTrigger2, { asChild: true, children: /* @__PURE__ */ jsx33(Button, { size: "icon", variant: "ghost", className: "h-6 w-6", children: /* @__PURE__ */ jsx33(Expand, { className: "h-4 w-4" }) }) }),
          /* @__PURE__ */ jsxs13(DialogContent2, { className: "max-w-4xl", children: [
            /* @__PURE__ */ jsx33(DialogHeader, { children: /* @__PURE__ */ jsx33(DialogTitle2, { children: (0, import_lodash7.startCase)(field.name) }) }),
            /* @__PURE__ */ jsxs13("div", { className: "grid gap-4", children: [
              /* @__PURE__ */ jsx33(
                Textarea,
                {
                  value: dialogValue,
              ...
              /* @__PURE__ */ jsxs13("div", { className: "flex justify-end gap-2", children: [
                /* @__PURE__ */ jsx33(Button, { variant: "outline", onClick: () => setDialogOpen(false), children: "Cancel" }),
                /* @__PURE__ */ jsx33(Button, { onClick: handleDialogSave, children: "Save" })
              ] })
            ] })
          ] })
        ] })
...
import { useState as useState18, useEffect as useEffect18, useId as useId8, useRef as useRef16 } from "react";
var import_lodash8 = __toESM(require_lodash());
import { Fragment as Fragment8, jsx as jsx34, jsxs as jsxs14 } from "react/jsx-runtime";
...
var ExternalFieldComponent = observer8(
  ({
    ...
    const [isLoadingSelected, setIsLoadingSelected] = useState18(false);
    const [selectedItem, setSelectedItem] = useState18(null);
    const [searchQuery, setSearchQuery] = useState18("");
    const [debouncedSearch, setDebouncedSearch] = useState18("");
    const [page, setPage] = useState18(1);
    const pageSize = 10;
    const [response, setResponse] = useState18({
      results: [],
      pagination: {
        page: 1,
        pageSize,
    ...
    return /* @__PURE__ */ jsxs14("div", { className: "grid w-full max-w-sm items-center gap-1.5", children: [
      /* @__PURE__ */ jsx34(Label2, { htmlFor: id, onClick: () => buttonRef.current?.click(), className: "cursor-pointer", children: (0, import_lodash8.startCase)(field.name) }),
      /* @__PURE__ */ jsxs14("div", { className: "flex gap-2", children: [
        ...
        /* @__PURE__ */ jsxs14(Dialog2, { open, onOpenChange: setOpen, children: [
          /* @__PURE__ */ jsx34(DialogTrigger2, { asChild: true, children: /* @__PURE__ */ jsx34(Button, { ref: buttonRef, type: "button", variant: "outline", size: "sm", children: "Select" }) }),
          /* @__PURE__ */ jsxs14(DialogContent2, { className: "sm:max-w-[680px] h-[80vh] flex flex-col", children: [
            /* @__PURE__ */ jsx34(DialogHeader, { className: "shrink-0", children: /* @__PURE__ */ jsx34(DialogTitle2, { children: "Select Item" }) }),
            /* @__PURE__ */ jsx34("div", { className: "shrink-0 mb-4", children: /* @__PURE__ */ jsx34(
              Input,
              {
            ...
            isLoading ? /* @__PURE__ */ jsx34("div", { className: "flex-1 flex items-center justify-center", children: "Loading items..." }) : /* @__PURE__ */ jsxs14(Fragment8, { children: [
              /* @__PURE__ */ jsx34("div", { className: "flex-1 space-y-2 overflow-y-auto min-h-0", children: items2.length > 0 ? items2.map((item) => /* @__PURE__ */ jsxs14(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx34("div", { className: "font-medium", children: item.label }),
                    /* @__PURE__ */ jsx34("div", { className: "text-xs text-muted-foreground", children: item.id })
                  ]
                },
                item.id
              )) : /* @__PURE__ */ jsx34("div", { className: "flex items-center justify-center h-full text-muted-foreground", children: "No items found" }) }),
              (hasNextPage || hasPrevPage) && /* @__PURE__ */ jsxs14("div", { className: "shrink-0 flex items-center justify-between mt-4 pt-4 border-t", children: [
                /* @__PURE__ */ jsx34(
                  Button,
                  {
                    variant: "outline",
      ...
      value && /* @__PURE__ */ jsx34("div", { className: "mt-1 border rounded p-2 bg-muted/50", children: isLoadingSelected ? /* @__PURE__ */ jsx34("div", { className: "text-sm text-muted-foreground", children: "Loading item..." }) : selectedItem ? /* @__PURE__ */ jsxs14("div", { className: "text-sm", children: [
        /* @__PURE__ */ jsx34("div", { className: "font-medium", children: selectedItem.label }),
        /* @__PURE__ */ jsx34("div", { className: "text-xs text-muted-foreground", children: selectedItem.id })
      ] }) : /* @__PURE__ */ jsx34("div", { className: "text-sm text-muted-foreground", children: "Item not found" }) })
    ] });
  }
);

// src/store/Field.tsx
import { Fragment as Fragment9, jsx as jsx35, jsxs as jsxs15 } from "react/jsx-runtime";
...
var FieldComponent = observer9(
  ({
    ...
    return /* @__PURE__ */ jsxs15(Fragment9, { children: [
      field.type === "text" && /* @__PURE__ */ jsx35(TextFieldComponent, { field, node, path }),
      field.type === "number" && /* @__PURE__ */ jsx35(NumberFieldComponent, { field, node, path }),
      field.type === "checkbox" && /* @__PURE__ */ jsx35(CheckboxFieldComponent, { field, node, path }),
      field.type === "select" && /* @__PURE__ */ jsx35(SelectFieldComponent, { field, node, path }),
      field.type === "array" && /* @__PURE__ */ jsx35(ArrayFieldComponent, { field, node, path }),
      field.type === "media" && /* @__PURE__ */ jsx35(MediaFieldComponent, { field, node, path }),
      field.type === "textarea" && /* @__PURE__ */ jsx35(TextareaFieldComponent, { field, node, path }),
      field.type === "external" && /* @__PURE__ */ jsx35(ExternalFieldComponent, { field, node, path })
    ] });
  }
);
...
var Node2 = types12.model("Node", {
  ...
  children: types12.union(types12.array(types12.late(() => Node2)), types12.undefined)
}).views((self2) => ({
  getPropValue(path) {
...
var RootStore = types13.model("RootStore", {
  root: Node2,
  selectedNode: types13.maybeNull(types13.reference(Node2)),
  blocks: types13.array(Block)
}).views((self2) => ({
  get data() {
    return self2.root.children ? getSnapshot2(self2.root.children, false) : [];
  },
  get openMap() {
  ...
  createNode: (parentId, _index, type) => {
    ...
    console.log("before", self2.selectedNode && getSnapshot2(self2.selectedNode));
    self2.selectedNode = node;
    console.log("after", getSnapshot2(self2.selectedNode));
...
var StoreContext = createContext5(null);
var StoreProvider = StoreContext.Provider;
var StoreHistoryContext = createContext5(null);
var StoreHistoryProvider = StoreHistoryContext.Provider;
var useStore = () => {
  const store = useContext4(StoreContext);
  if (!store) {
...
var useStoreHistory = () => {
  const history = useContext4(StoreHistoryContext);
  if (!history) {
...
var BlockEditor = observer10(() => {
  ...
  return /* @__PURE__ */ jsxs16("div", { className: "flex flex-col gap-4", children: [
    /* @__PURE__ */ jsx36("h2", { className: "text-lg font-bold", children: (0, import_lodash10.startCase)(component.type) }),
    /* @__PURE__ */ jsxs16("div", { className: "grid w-full max-w-sm items-center gap-1.5", children: [
      /* @__PURE__ */ jsx36(Label2, { htmlFor: "block-name", children: "Block Name" }),
      /* @__PURE__ */ jsx36(
        Input,
        {
          id: "block-name",
    ...
    /* @__PURE__ */ jsx36("hr", {}),
    component.fields.map((field) => /* @__PURE__ */ jsx36(FieldComponent, { field, node, path: [] }, field.name))
  ] }, node.id);
});

// src/components/Canvas.tsx
import { useCallback as useCallback10, useEffect as useEffect19, useRef as useRef17, useState as useState19 } from "react";
...
function Canvas({
  ...
  const [selectedViewport, setSelectedViewport] = useState19(
    DEFAULT_VIEWPORT
  );
  const [zoomLevel, setZoomLevel] = useState19(1);
  const [maxZoom, setMaxZoom] = useState19(MAX_ZOOM);
  const [containerSize, setContainerSize] = useState19({ width: 0, height: 0 });
  const [inspectMode, setInspectMode] = useState19(false);
  const containerRef = useRef17(null);
  const overlayId = "selected-block-overlay";
  const hoverOverlayId = "hover-block-overlay";
  const updateContainerSize = useCallback10(() => {
    if (!containerRef.current) return;
    const { offsetWidth, offsetHeight } = containerRef.current;
    setContainerSize({ width: offsetWidth, height: offsetHeight });
  }, []);
  const calculateMaxZoom = useCallback10(() => {
  ...
  const updateZoomLevel = useCallback10(() => {
    updateContainerSize();
  ...
  const handleZoomIn = useCallback10(() => {
    setZoomLevel((prev) => Math.min(prev + ZOOM_STEP, maxZoom));
  }, [maxZoom]);
  const handleZoomOut = useCallback10(() => {
    setZoomLevel((prev) => Math.max(prev - ZOOM_STEP, MIN_ZOOM));
  }, []);
  const handleViewportChange = useCallback10((value) => {
  ...
  const toggleInspectMode = useCallback10(() => {
    setInspectMode((prev) => !prev);
  }, []);
  if (!selectedViewport) return null;
  return /* @__PURE__ */ jsxs17("div", { className: cn("border flex flex-col h-full", className), children: [
    /* @__PURE__ */ jsxs17("div", { className: "flex justify-between items-center p-2", children: [
      /* @__PURE__ */ jsx37("div", { children: /* @__PURE__ */ jsxs17(Select2, { value: selectedViewport.name, onValueChange: handleViewportChange, children: [
        /* @__PURE__ */ jsx37(SelectTrigger2, { className: "w-[220px]", children: /* @__PURE__ */ jsx37(SelectValue2, { placeholder: "Select viewport" }) }),
        /* @__PURE__ */ jsx37(SelectContent2, { children: VIEWPORTS.map((viewport) => /* @__PURE__ */ jsx37(SelectItem2, { value: viewport.name, children: viewport.name }, viewport.name)) })
      ] }) }),
      /* @__PURE__ */ jsxs17("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx37(
          Button,
          {
            ...
            children: /* @__PURE__ */ jsx37(MousePointer, { className: "h-4 w-4" })
          }
        ),
        /* @__PURE__ */ jsx37(
          Button,
          {
            ...
            children: /* @__PURE__ */ jsx37(Minus, { className: "h-4 w-4" })
          }
        ),
        /* @__PURE__ */ jsxs17("span", { className: "w-12 text-center", children: [
        ...
        /* @__PURE__ */ jsx37(
          Button,
          {
            ...
            children: /* @__PURE__ */ jsx37(Plus, { className: "h-4 w-4" })
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsx37("div", { ref: containerRef, className: "relative border overflow-hidden flex-1", children: /* @__PURE__ */ jsx37(
      "div",
      {
        style: {
        ...
        className: "mx-auto",
        children: /* @__PURE__ */ jsx37("iframe", { ref: iframeRef, src: url, className: "border-0 w-full h-full", title: "Preview" })
      }
    ) })
  ] });
}
...
var RovingFocusGroup = React40.forwardRef(
  (props, forwardedRef) => {
    return /* @__PURE__ */ jsx38(Collection3.Provider, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsx38(Collection3.Slot, { scope: props.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsx38(RovingFocusGroupImpl, { ...props, ref: forwardedRef }) }) });
  }
);
...
var Menu = (props) => {
  ...
  return /* @__PURE__ */ jsx39(Root23, { ...popperScope, children: /* @__PURE__ */ jsx39(
    MenuProvider,
    {
      scope: __scopeMenu,
      open,
...
var MenuAnchor = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope2(__scopeMenu);
    return /* @__PURE__ */ jsx39(Anchor, { ...popperScope, ...anchorProps, ref: forwardedRef });
  }
);
...
var MenuPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx39(PortalProvider2, { scope: __scopeMenu, forceMount, children: /* @__PURE__ */ jsx39(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx39(Portal, { asChild: true, container, children }) }) });
};
...
var MenuContent = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx39(Collection4.Provider, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsx39(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx39(Collection4.Slot, { scope: props.__scopeMenu, children: rootContext.modal ? /* @__PURE__ */ jsx39(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ jsx39(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx39(
      MenuContentProvider,
      {
        ...
        children: /* @__PURE__ */ jsx39(ScrollLockWrapper, { ...scrollLockWrapperProps, children: /* @__PURE__ */ jsx39(
          FocusScope,
          {
            asChild: true,
            trapped: trapFocus,
...
var MenuGroup = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx39(Primitive.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx39(Primitive.div, { ...labelProps, ref: forwardedRef });
  }
);
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx39(
      Collection4.ItemSlot,
      {
        ...
        children: /* @__PURE__ */ jsx39(Item3, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: /* @__PURE__ */ jsx39(
          Primitive.div,
          {
            role: "menuitem",
            "data-highlighted": isFocused ? "" : void 0,
...
var MenuCheckboxItem = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx39(ItemIndicatorProvider, { scope: props.__scopeMenu, checked, children: /* @__PURE__ */ jsx39(
      MenuItem,
      {
...
var MenuRadioGroup = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx39(RadioGroupProvider, { scope: props.__scopeMenu, value, onValueChange: handleValueChange, children: /* @__PURE__ */ jsx39(MenuGroup, { ...groupProps, ref: forwardedRef }) });
  }
);
...
var MenuArrow = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    const popperScope = usePopperScope2(__scopeMenu);
    return /* @__PURE__ */ jsx39(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var MenuSubTrigger = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx39(MenuAnchor, { asChild: true, ...scope2, children: /* @__PURE__ */ jsx39(
      MenuItemImpl,
      {
...
var MenuSubContent = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = React41.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return /* @__PURE__ */ jsx39(Collection4.Provider, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsx39(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx39(Collection4.Slot, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsx39(
      MenuContentImpl,
      {
...
var DropdownMenu = (props) => {
  ...
  return /* @__PURE__ */ jsx40(
    DropdownMenuProvider,
    {
      ...
      modal,
      children: /* @__PURE__ */ jsx40(Root32, { ...menuScope, open, onOpenChange: setOpen, dir, modal, children })
    }
  );
};
...
var DropdownMenuTrigger = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return /* @__PURE__ */ jsx40(Anchor2, { asChild: true, ...menuScope, children: /* @__PURE__ */ jsx40(
      Primitive.button,
      {
        type: "button",
...
var DropdownMenuPortal = (props) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ jsx40(Portal4, { ...menuScope, ...portalProps });
};
...
var DropdownMenuGroup = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return /* @__PURE__ */ jsx40(Group2, { ...menuScope, ...groupProps, ref: forwardedRef });
  }
);
...
var DropdownMenuLabel = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return /* @__PURE__ */ jsx40(Label4, { ...menuScope, ...labelProps, ref: forwardedRef });
  }
);
...
var DropdownMenuItem = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return /* @__PURE__ */ jsx40(Item22, { ...menuScope, ...itemProps, ref: forwardedRef });
  }
);
...
var DropdownMenuCheckboxItem = React42.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ jsx40(CheckboxItem, { ...menuScope, ...checkboxItemProps, ref: forwardedRef });
});
...
var DropdownMenuRadioGroup = React42.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ jsx40(RadioGroup, { ...menuScope, ...radioGroupProps, ref: forwardedRef });
});
...
var DropdownMenuRadioItem = React42.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ jsx40(RadioItem, { ...menuScope, ...radioItemProps, ref: forwardedRef });
});
...
var DropdownMenuItemIndicator = React42.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ jsx40(ItemIndicator2, { ...menuScope, ...itemIndicatorProps, ref: forwardedRef });
});
...
var DropdownMenuSeparator = React42.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ jsx40(Separator2, { ...menuScope, ...separatorProps, ref: forwardedRef });
});
...
var DropdownMenuArrow = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeDropdownMenu);
    return /* @__PURE__ */ jsx40(Arrow22, { ...menuScope, ...arrowProps, ref: forwardedRef });
  }
);
...
var DropdownMenuSubTrigger = React42.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ jsx40(SubTrigger, { ...menuScope, ...subTriggerProps, ref: forwardedRef });
});
...
function DropdownMenu2({
  ...
  return /* @__PURE__ */ jsx41(Root25, { "data-slot": "dropdown-menu", ...props });
}
...
function DropdownMenuContent2({
  ...
  return /* @__PURE__ */ jsx41(Portal22, { children: /* @__PURE__ */ jsx41(
    Content24,
    {
...
import { useEffect as useEffect32, useRef as useRef25, useState as useState25 } from "react";
...
import { useEffect as useEffect30, useImperativeHandle, useMemo as useMemo21, useRef as useRef23 } from "react";
...
var TreeApiContext = createContext6(null);
function useTreeApi() {
  const value = useContext5(TreeApiContext);
  if (value === null)
    throw new Error("No Tree Api Provided");
  return value;
}
var NodesContext = createContext6(null);
function useNodesContext() {
  const value = useContext5(NodesContext);
  if (value === null)
    throw new Error("Provide a NodesContext");
  return value;
}
var DndContext = createContext6(null);
function useDndContext() {
  const value = useContext5(DndContext);
  if (value === null)
    throw new Error("Provide a DnDContext");
  return value;
}
var DataUpdatesContext = createContext6(0);
function useDataUpdates() {
  useContext5(DataUpdatesContext);
}
...
var DefaultCursor = React43.memo(function DefaultCursor2({ top, left, indent }) {
  const style = {
    position: "absolute",
    pointerEvents: "none",
    top: top - 2 + "px",
...
function DefaultRow({ node, attrs, innerRef, children }) {
  return _jsx2("div", Object.assign({}, attrs, { ref: innerRef, onFocus: (e) => e.stopPropagation(), onClick: node.handleClick, children }));
}
...
function DefaultNode(props) {
  return _jsxs2("div", { ref: props.dragHandle, style: props.style, children: [_jsx3("span", { onClick: (e) => {
    e.stopPropagation();
    props.node.toggle();
  }, children: props.node.isLeaf ? "\u{1F333}" : props.node.isOpen ? "\u{1F5C1}" : "\u{1F5C0}" }), " ", props.node.isEditing ? _jsx3(Edit, Object.assign({}, props)) : _jsx3(Show, Object.assign({}, props))] });
}
function Show(props) {
  return _jsx3(_Fragment, { children: _jsx3("span", { children: props.node.data.name }) });
}
function Edit({ node }) {
  const input = useRef21();
  useEffect22(() => {
    var _a, _b;
...
function DefaultDragPreview({ offset: offset4, mouse, id, dragIds, isDragging }) {
  return _jsxs3(Overlay2, { isDragging, children: [_jsx4(Position, { offset: offset4, children: _jsx4(PreviewNode, { id, dragIds }) }), _jsx4(Count, { mouse, count: dragIds.length })] });
}
var Overlay2 = memo(function Overlay3(props) {
  if (!props.isDragging)
    return null;
  return _jsx4("div", { style: layerStyles, children: props.children });
});
function Position(props) {
  return _jsx4("div", { className: "row preview", style: getStyle(props.offset), children: props.children });
}
function Count(props) {
  const { count: count3, mouse } = props;
  if (count3 > 1)
    return _jsx4("div", { className: "selected-count", style: getCountStyle(mouse), children: count3 });
  else
    return null;
}
var PreviewNode = memo(function PreviewNode2(props) {
  const tree = useTreeApi();
  const node = tree.get(props.id);
  if (!node)
    return null;
  return _jsx4(tree.renderNode, { preview: true, node, style: {
...
import { createElement as createElement8, PureComponent } from "react";
    ...
    _proto.render = function render() {
      ...
      if (itemCount > 0) {
        for (var _index = startIndex; _index <= stopIndex; _index++) {
          items2.push(createElement8(children, {
            data: itemData,
      ...
      return createElement8(outerElementType || outerTagName || "div", {
        className,
        onScroll,
      ...
      }, createElement8(innerElementType || innerTagName || "div", {
        children: items2,
        ref: innerRef,
        style: {
...
function Cursor() {
  ...
  return _jsx5(Cursor2, { top, left, indent });
}
...
var ListOuterElement = forwardRef21(function Outer(props, ref) {
  const { children } = props, rest = __rest2(props, ["children"]);
  const tree = useTreeApi();
  return _jsxs4("div", Object.assign({
    // @ts-ignore
    ref
  }, rest, { onClick: (e) => {
    if (e.currentTarget === e.target)
      tree.deselectAll();
  }, children: [_jsx6(DropContainer, {}), children] }));
});
var DropContainer = () => {
  const tree = useTreeApi();
  return _jsx6("div", { style: {
    height: tree.visibleNodes.length * tree.rowHeight,
    width: "100%",
    position: "absolute",
    left: "0",
    right: "0"
  }, children: _jsx6(Cursor, {}) });
};
...
var ListInnerElement = forwardRef22(function InnerElement(_a, ref) {
  var _b, _c, _d, _e;
  var { style } = _a, rest = __rest3(_a, ["style"]);
  const tree = useTreeApi();
  ...
  return _jsx7("div", Object.assign({ ref, style: Object.assign(Object.assign({}, style), { height: `${parseFloat(style.height) + paddingTop + paddingBottom}px` }) }, rest));
});
...
import React44, { useCallback as useCallback15, useEffect as useEffect29, useMemo as useMemo20, useRef as useRef22 } from "react";
...
var DndContext2 = createContext7({
...
import { useEffect as useEffect23, memo as memo2 } from "react";
...
function xor(itemsA, itemsB) {
  ...
  var result = [];
  map.forEach(function(count3, key) {
    if (count3 === 1) {
      result.push(key);
    }
  });
...
function createStore(reducer7, preloadedState, enhancer) {
  ...
  function observable() {
    ...
    return _ref = {
       ...
       */
      subscribe: function subscribe2(observer12) {
        if (typeof observer12 !== "object" || observer12 === null) {
          throw new Error(false ? formatProdErrorMessage(11) : "Expected the observer to be an object. Instead, received: '" + kindOf(observer12) + "'");
        }
        function observeState() {
          if (observer12.next) {
            observer12.next(getState5());
          }
        }
        observeState();
...
function makeRequestCallFromMutationObserver(callback) {
  let toggle = 1;
  const observer12 = new BrowserMutationObserver(callback);
  const node = document.createTextNode("");
  observer12.observe(node, {
    characterData: true
  });
  return function requestCall() {
    toggle = -toggle;
...
var DndProvider = memo2(function DndProvider2(_ref) {
  ...
  return _jsx8(DndContext2.Provider, Object.assign({
    value: manager
  }, {
    children
  }), void 0);
...
import { cloneElement as cloneElement4, isValidElement as isValidElement2 } from "react";
...
function wrapHookToRecognizeElement(hook) {
  return function() {
    ...
    if (!isValidElement2(elementOrNode)) {
...
import { useLayoutEffect as useLayoutEffect5, useEffect as useEffect24 } from "react";
var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? useLayoutEffect5 : useEffect24;
...
import { useEffect as useEffect25, useMemo as useMemo8 } from "react";
...
function useDragDropManager() {
  var _useContext = useContext6(DndContext2), dragDropManager = _useContext.dragDropManager;
...
function useDragSourceConnector(dragSourceOptions, dragPreviewOptions) {
  var manager = useDragDropManager();
  var connector = useMemo12(function() {
...
import { useState as useState22, useCallback as useCallback14 } from "react";
...
import { useEffect as useEffect26, useMemo as useMemo15 } from "react";
...
function useDropTarget(spec, monitor) {
  var dropTarget = useMemo15(function() {
...
function useDropTargetConnector(options) {
  var manager = useDragDropManager();
  var connector = useMemo17(function() {
...
// node_modules/.pnpm/react-arborist@3.4.3_@types+node@22.17.2_@types+react@19.1.10_react-dom@19.1.1_react@19.1.1__react@19.1.1/node_modules/react-arborist/dist/module/components/row-container.js
var RowContainer = React44.memo(function RowContainer2({ index: index2, style }) {
  useDataUpdates();
  const _ = useNodesContext();
  const tree = useTreeApi();
  const node = useFreshNode(index2);
  const el = useRef22(null);
  const dragRef = useDragHook(node);
  const dropRef = useDropHook(el, node);
  const innerRef = useCallback15((n) => {
    el.current = n;
    dropRef(n);
  }, [dropRef]);
  const indent = tree.indent * node.level;
  const nodeStyle = useMemo20(() => ({ paddingLeft: indent }), [indent]);
  const rowStyle = useMemo20(() => {
    var _a, _b;
  ...
  return _jsx9(Row, { node, innerRef, attrs: rowAttrs, children: _jsx9(Node3, { node, tree, style: nodeStyle, dragHandle: dragRef }) });
});
...
function DefaultContainer() {
  useDataUpdates();
  const tree = useTreeApi();
  return _jsx10("div", { role: "tree", style: {
    height: tree.height,
    width: tree.width,
    minHeight: 0,
    minWidth: 0
    ...
    if (node)
      tree.focus(node.id);
  }, children: _jsx10(FixedSizeList, { className: tree.props.className, outerRef: tree.listEl, itemCount: tree.visibleNodes.length, height: tree.height, width: tree.width, itemSize: tree.rowHeight, overscanCount: tree.overscanCount, itemKey: (index2) => {
    var _a;
...
var TreeApi = class _TreeApi {
  ...
  selectAll() {
    ...
    this.dispatch(focus2((_a = this.lastNode) === null || _a === void 0 ? void 0 : _a.id));
    if (this.focusedNode)
      safeRun2(this.props.onFocus, this.focusedNode);
    safeRun2(this.props.onSelect, this.selectedNodes);
  }
  ...
  function observable() {
    ...
    return {
      ...
      subscribe(observer12) {
        if (typeof observer12 !== "object" || observer12 === null) {
          throw new Error(false ? formatProdErrorMessage(11) : `Expected the observer to be an object. Instead, received: '${kindOf2(observer12)}'`);
        }
        function observeState() {
          const observerAsObserver = observer12;
...
function TreeProvider({ treeProps, imperativeHandle, children }) {
  const list = useRef23(null);
  const listEl = useRef23(null);
  const store = useRef23(
    // @ts-ignore
  ...
  return _jsx11(TreeApiContext.Provider, { value: api, children: _jsx11(DataUpdatesContext.Provider, { value: updateCount.current, children: _jsx11(NodesContext.Provider, { value: state.nodes, children: _jsx11(DndContext.Provider, { value: state.dnd, children: _jsx11(DndProvider, Object.assign({ backend: HTML5Backend, options: { rootElement: api.props.dndRootElement || void 0 } }, treeProps.dndManager && { manager: treeProps.dndManager }, { children })) }) }) }) });
}
...
import { jsx as _jsx12, Fragment as _Fragment2 } from "react/jsx-runtime";
function TreeContainer() {
  const tree = useTreeApi();
  const Container = tree.props.renderContainer || DefaultContainer;
  return _jsx12(_Fragment2, { children: _jsx12(Container, {}) });
}
...
function DragPreviewContainer() {
  ...
  return _jsx13(DragPreview, { offset: offset4, mouse, id: (item === null || item === void 0 ? void 0 : item.id) || null, dragIds: (item === null || item === void 0 ? void 0 : item.dragIds) || [], isDragging });
}
...
function useSimpleTree(initialData) {
  ...
  const tree = useMemo22(() => new SimpleTree(data), [data]);
  const onMove = (args) => {
...
function TreeComponent(props, ref) {
  ...
  return _jsxs5(TreeProvider, { treeProps, imperativeHandle: ref, children: [_jsx14(OuterDrop, { children: _jsx14(TreeContainer, {}) }), _jsx14(DragPreviewContainer, {})] });
}
var Tree = forwardRef23(TreeComponent);
...
import { useRef as useRef24, useEffect as useEffect31, useCallback as useCallback16, useState as useState24, useMemo as useMemo23 } from "react";
function useResolvedElement(subscriber, refOrElement) {
  var lastReportRef = useRef24(null);
  var refOrElementRef = useRef24(null);
  refOrElementRef.current = refOrElement;
  var cbElementRef = useRef24(null);
  useEffect31(function() {
    evaluateSubscription();
  });
  var evaluateSubscription = useCallback16(function() {
  ...
  return useCallback16(function(element) {
...
function useResizeObserver(opts) {
  ...
  var previous = useRef24({
    width: void 0,
    height: void 0
  });
  var refCallback = useResolvedElement(useCallback16(function(element) {
...
import { Fragment as Fragment11, jsx as jsx42, jsxs as jsxs19 } from "react/jsx-runtime";
var PageBuilder = ({
  blocks,
  initialData,
  onDataChange,
  ...
  const [{ store, history }] = useState25(() => createStoreAndHistory(blocks));
  useEffect32(() => {
    if (initialData) {
  ...
  return /* @__PURE__ */ jsx42(StoreProvider, { value: store, children: /* @__PURE__ */ jsx42(StoreHistoryProvider, { value: history, children: /* @__PURE__ */ jsx42(
    PageBuilderInner,
    {
      onSave,
      onPublish,
...
var PageBuilderInner = observer11(({
  ...
  return /* @__PURE__ */ jsxs19("div", { className: cn("h-screen flex", className), children: [
    /* @__PURE__ */ jsxs19("div", { className: "flex flex-col", children: [
      /* @__PURE__ */ jsxs19("div", { className: "flex justify-between items-center p-2 border-b", children: [
        /* @__PURE__ */ jsx42(History, {}),
        saving && /* @__PURE__ */ jsx42("div", { children: "saving" }),
        /* @__PURE__ */ jsxs19(DropdownMenu2, { children: [
          /* @__PURE__ */ jsx42(DropdownMenuTrigger2, { asChild: true, children: /* @__PURE__ */ jsx42(Button, { variant: "ghost", size: "icon", children: /* @__PURE__ */ jsx42(EllipsisVertical, { className: "w-4 h-4" }) }) }),
          /* @__PURE__ */ jsxs19(DropdownMenuContent2, { onCloseAutoFocus: (e) => e.preventDefault(), children: [
            onSave && /* @__PURE__ */ jsx42(DropdownMenuItem2, { onClick: handleSave, children: "Save" }),
            onPublish && /* @__PURE__ */ jsx42(DropdownMenuItem2, { onClick: handlePublish, children: "Publish" }),
            /* @__PURE__ */ jsx42(
              DropdownMenuItem2,
              {
                onClick: async (e) => {
            ...
            /* @__PURE__ */ jsx42(DropdownMenuSeparator2, {}),
            /* @__PURE__ */ jsx42(DropdownMenuLabel2, { children: "Add Block" }),
            store.blocks.map((block) => /* @__PURE__ */ jsx42(
              DropdownMenuItem2,
              {
                onClick: (e) => {
                  e.stopPropagation();
      ...
      /* @__PURE__ */ jsx42("div", { ref: treeContainer.ref, className: "flex-1 min-h-0", children: /* @__PURE__ */ jsx42(
        Tree,
        {
          rowHeight: 40,
    ...
    /* @__PURE__ */ jsx42("div", { className: "flex-1 min-w-0", children: previewUrl && /* @__PURE__ */ jsx42(
      Canvas,
      {
        iframeRef,
        url: previewUrl,
    ...
    /* @__PURE__ */ jsx42("div", { className: "w-[300px] p-4 overflow-auto", children: /* @__PURE__ */ jsx42(BlockEditor, {}) })
  ] });
});
var History = observer11(() => {
  const history = useStoreHistory();
  return /* @__PURE__ */ jsxs19("div", { className: "flex gap-2", children: [
    /* @__PURE__ */ jsx42(Button, { onClick: () => history.undo(), disabled: !history.canUndo, children: "Undo" }),
    /* @__PURE__ */ jsx42(Button, { onClick: () => history.redo(), disabled: !history.canRedo, children: "Redo" })
  ] });
});
      ...
      children: [
        /* @__PURE__ */ jsx42(
          Button,
          {
            ...
            children: /* @__PURE__ */ jsx42(Fragment11, { children: node.children?.length === 0 ? /* @__PURE__ */ jsx42(Minus, { className: "w-4 h-4" }) : node.isClosed ? /* @__PURE__ */ jsx42(ChevronDown, { className: "w-4 h-4" }) : /* @__PURE__ */ jsx42(ChevronUp, { className: "w-4 h-4" }) })
          }
        ),
        /* @__PURE__ */ jsx42("div", { className: "flex-1", children: node.data.name }),
        /* @__PURE__ */ jsxs19(DropdownMenu2, { open, onOpenChange: setOpen, children: [
          /* @__PURE__ */ jsx42(DropdownMenuTrigger2, { asChild: true, children: /* @__PURE__ */ jsx42(
            Button,
            {
              variant: "ghost",
              size: "icon",
              className: cn("opacity-0 group-hover:opacity-100 transition", open && "opacity-100"),
              children: /* @__PURE__ */ jsx42(EllipsisVertical, { className: "w-4 h-4" })
            }
          ) }),
          /* @__PURE__ */ jsxs19(DropdownMenuContent2, { onCloseAutoFocus: (e) => e.preventDefault(), children: [
            /* @__PURE__ */ jsx42(
